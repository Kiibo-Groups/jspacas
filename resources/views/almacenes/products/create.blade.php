...
<script>
    ...
    // Generado de numero para Codigo de barras
    let len = 8;
    function generateNumber()
    {
        let code = Math.floor(Math.pow(10, Math.ceil(10) - 1) + Math.random() *  (Math.pow(10, Math.ceil(10)) - Math.pow(10, Math.ceil(10) - 1) - 1));
