...
@section('title')
    JSPacas | Ingresa a tu panel Administrattivo
@endsection

@section('content')
    <div class="px-5 ms-xl-5">
        <h4 class="text-uppercase mt-4 pt-5 mt-xl-5">Bienvenido(a) a tu Cuenta</h4>
        <p class="text-muted mt-2 mb-4 pb-2">Ingresa tus datos para iniciar sesión</p>
    </div>
    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-5 mt-5 pt-5 pt-xl-0 mt-xl-n5">
        <form method="POST" action="{{ $form_url }}" style="width: 23rem;">
            @csrf
            ...
            <p class="small mb-5 pb-lg-2"><a class="text-muted" href="#!">Has olvidado la Contraseña? <b>Recuperala</b></a></p>
